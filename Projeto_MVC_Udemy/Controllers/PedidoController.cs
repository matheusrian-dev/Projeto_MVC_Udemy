...
namespace Projeto_LanchesMac_Udemy.Controllers
{
    public class PedidoController : Controller
    {
        ...
        public IActionResult Checkout(Pedido pedido)
        {
            ...
            List<ItemCarrinhoCompra> items = _carrinhoCompra.GetCarrinhoCompraItens();

            //verifica se existem itens de pedido
            if(_carrinhoCompra.ItensCarrinhoCompra.Count == 0)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                ViewBag.CheckoutCompleteMensagem = "Obrigado pelo seu pedido! :D";
